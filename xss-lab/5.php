...
<body>
	...
	<a href="index.php">🏠 Main</a>
        ...
        <a href="5.php?input=A" class="active">🟡 Level 5</a>
    ...
    <div class="container">
        <h1>Level 5: XSS</h1>
     	 <p> يبدو أن هذا سيكون سهلاً هذه المرة، فقد نسي مطور الموقع وضع أي نوع من أنواع الحماية  </p>
        <form method="GET">
        ...
        <div class="hints">
            ...
            <div id="hint1-content" class="hint-content">
                        	حاول النظر إلى المكان الذي يتم فيه إدخال الكود 
            </div>
            ...
            <div id="hint3-content" class="hint-content">
                        : مثل Event Handlers يمكنك استخداد <br><br> "onclick=alert(1) "   <br><br>   كاملاً، ثم اضغط على الصورة ليتم تنفيذ الأمر HTML لا تنسَ أن تكتب علامتي " " لكي يكون كود الـ  
            </div>
        </div>
        <footer>
            Ahmed Mahmoud Selim
