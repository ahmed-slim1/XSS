...
<body>
    <div class="navbar">
        ...
        <a href="9.php" class="active">🔴 Level 9</a>
        <a href="10.php">🔴 Level 10</a>
        <a href="impossible.php">🛡️ Impossible</a>
    </div>
    <div class="container">
        <h1>Level 9: XSS</h1>
        <p> JSON إنه نفس المستوى السابق، لكن تم إصلاح المشكلة، لذا يجب أن يكون الكود بصيغة </p>
        <p> فأنت بذلك تعرف الحل JSON	إذا كنت قد تخطيت المستوى السابق باستخدام صيغة </p>
        <form method="POST">
    ...
    ?>
        ...
        <div class="hints">
            ...
            <div id="hint3-content" class="hint-content">
                         <?php
    // JSON الذي نريد عرضه كنص
    $json_data = '{"message":"<img src=x onerror=alert(\'XSS\')>"}';
    
    // عرض النص كنص عادي
    echo "<pre>" . htmlspecialchars($json_data, ENT_QUOTES, 'UTF-8') . "</pre>";
    ?>
            </div>
        </div>
        <footer>
