...
<body>
	...
	<a href="index.php">🏠 Main</a>
        ...
        <a href="2.php" class="active" >🟢 Level 2</a>
    ...
    <div class="container">
        <h1>Level 2: XSS </h1>
        <p> ولكن هذا لا يزال سهلاً، أليس كذلك؟ XSS يبدوا ان مطور الموقع قد أضاف بعض الحمايه لمنع هجمات ال  </p>
        <p> <code>&lt;script&gt;&lt;/script&gt;</code>  للاستفادة من التحدي، يجب عليك كتابة الكودبين وسمي </p>  
	 <form method="GET">
        ...
        <div class="hints">
            ...
            <div id="hint1-content" class="hint-content">
                       تقد تم حظره، حاول كتابته بشكل مختلف  <code>&lt;script&gt;</code> يبدو أن وسم  
            </div>
            <div id="hint2-content" class="hint-content">
                 ليست حساسة لحالة الأحرف HTML يبدوا ان مطور الموقع لا يعلم بأن العلامات في لغة 
            </div>
            <div id="hint3-content" class="hint-content">
              . <code>&lt;SCRIPT&gt;alert('XSS')&lt;/SCRIPT&gt;</code> حاول استخدام كود مثل
            </div>
        </div>
        <footer>
            Ahmed Mahmoud Selim
