...
<body>
    ...
    <div class="container">
        <h1>Level 1: Basic XSS</h1>
        <p>هذه الصفحة تحتوي على حقل إدخال نصي يعرض المدخلات مباشرة دون معالجة. حاول إدخال كود  جافا سكريبت  في الحقل أدناه.</p>
        <form method="GET">
        ...
        if (isset($_GET['input'])) {
            ...
            echo $_GET['input']; // عرض المدخلات كما هي بدون تصفية
            echo '</div>';
        }
        ?>
        <div class="hints">
            ...
            <div id="hint1-content" class="hint-content">
                فكر في كيفية إدخال أكواد جافا سكريبت في الحقل.
            </div>
            <div id="hint2-content" class="hint-content">
               . <code>&lt;script&gt;</code> حاول استخدام 
            </div>
            <div id="hint3-content" class="hint-content">
                        <code>&lt;script&gt;alert('XSS')&lt;/script&gt;</code> : لعرض تنبيه يمكنك استخدام 
            </div>
        </div>
        <footer>
                          Ahmed Mahmoud Selim
