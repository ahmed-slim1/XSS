...
<body>
	...
	<a href="index.php">🏠 Main</a>
        ...
        <a href="7.php" class="active">🟠 Level 7</a>
    ...
    <div class="container">
        <h1>Level 7: XSS</h1>
     	 <p>    <code>data</code>، <code>confirm</code>، <code>alert</code> ، <code>prompt</code> , <code>eval</code> حسنًا، يبدو أن الأمور أصبحت أصعب. لقد قام مطور الموقع بحظر </p>
	 <p>  <code>alert(1)</code>  لتتمكن من حل هذا التحدي، لا بد أن تقوم بعمل</p> 
	 <form method="GET">
	   ...
	   if($finder){
        ...
        <div class="hints">
            ...
            <div id="hint1-content" class="hint-content">
            	String Concatenation هل تعرف ماهو ال  <br> Function Constructor و
            </div>
            <div id="hint2-content" class="hint-content">
              هو عملية دمج سلسلتين نصيتين أو أكثر لتكوين سلسلة نصية واحدة <= String Concatenation  <br> EX:<code> var f = 'al' + 'ert'; </code>
	                                                                        		<br><br>
	  هو أداة في جافا اسكريبت تتيح لك إنشاء دوال جديدة من سلسلة نصية تحتوي على كود جافا اسكريبت <= Function Constructor
	   </div>
