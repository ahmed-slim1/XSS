...
<body>
	...
	<a href="index.php">🏠 Main</a>
        ...
        <a href="4.php?input=imag.jpeg" class="active">🟡 Level 4</a>
    ...
    <div class="container">
        <h1>Level 4: XSS</h1>
        <p>  HTML ولاكن هذا لا يزالو سهلا إذا كنت تعرف القليل من  XSS يبدوا ان مطور الموقع قد أضاف بعض الحمايه لمنع هجمات ال  </p>
        <form method="GET">
        ...
        if (isset($_GET['input'])) {
            $input = $_GET['input'];
            $verify = "#$%^&*+-[];,/{}|:<>?~";
	    $x = strpbrk($input, $verify); // البحث عن أي من الأحرف غير المسموح بها في القيمة المدخلة
	   if($x){
        ...
        <div class="hints">
            ...
            <div id="hint1-content" class="hint-content">
                . حاول معرفة أين يتم إدخال الكود أو النص الذي تقوم بإدخاله عن طريق عرض مصدر الصفحة
            </div>
            <div id="hint2-content" class="hint-content">
                    لذا حاول التفكير في كيفية كتابة الكود هنا <code>&lt;img src='your text'&gt;</code>  النص الذي تقوم بإدخاله يكون داخل وسم 
            </div>
            <div id="hint3-content" class="hint-content">
                         <code>' onerror=alert('XSS') '</code>   يمكنك اسنخدام 
            </div>
        </div>
        <footer>
            Ahmed Mahmoud Selim
